...
Data sourced from processed EHR records

Medical Imaging View
Displays enhanced medical images generated in earlier milestones

Conditional handling to display a fallback message when an image is not linked to a patient record

Raw EHR Data View
Displays raw EHR data in JSON format

Enables inspection of underlying patient information used by the system
